...
const (
	...
	SigningResultStatusDuplicate_redemption SigningResultStatus = 1
	SigningResultStatusInvalid_issuer       SigningResultStatus = 2
)
...
func (e SigningResultStatus) String() string {
	...
	case SigningResultStatusOk:
		return "ok"
	case SigningResultStatusDuplicate_redemption:
...
func NewSigningResultStatusValue(raw string) (r SigningResultStatus, err error) {
	...
	case "duplicate_redemption":
		return SigningResultStatusDuplicate_redemption, nil
	case "invalid_issuer":

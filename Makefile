...
docker-test:
	...
	--attribute-definitions AttributeName=id,AttributeType=S AttributeName=issuerId,AttributeType=S \
	--key-schema AttributeName=id,KeyType=HASH AttributeName=issuerId,KeyType=RANGE \
